                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                ?>" placeholder="Your Nick *" required="required"
                            ...
                            <div class="form-group">
                                ...
                                ?>" placeholder="Your Surname *" required="required"
                            ...
                            <div class="form-group">
                                ...
                                ?>" type="text" placeholder="Your Miasto *" required="required"
                            ...
                            <div class="form-group">
                                ...
                                ?>" type="text" placeholder="Your Adres *" required="required"
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <form action="zaloguj.php" method="post">
                    ...
                    <div class="col-lg-12  text-center">
                        <div class="form-group">
                            <input class="form-control" name="login" type="text" placeholder="Your Login *"
                                   required="required" data-validation-required-message="Please enter your login.">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                            <input class="form-control" name="haslo" type="password" placeholder="Your Password *"
                    ...
                    <div class="col-lg-12 text-center">
                        <div id="success"></div>
                        <input value="Zaloguj się" id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase"
                               type="submit"><br/><br/><br/>
